...
define(function () {
    ...
    (function () {
        ...
        _Message = (function (_super) {
            ...
            __extends(_Message, _super); //直接复制baseView的prototype方法到message对象里
    ...
    return {
        self: $.globalMessenger,
        setDefault: $.__messengerDefaults,
    }
