/**
*   电力抢修
*   @class Hmap.Plot.Routelabel.PowerRoute
*/
...
define(['BaseRoute', 'Hobject', 'GeoLineString', 'Hmath', 'GeoPolygon'], function (BaseRoute, Hobject, GeoLineString, Hmath, GeoPolygon) {
    ...
    var _powerRoute = function () {
        BaseRoute.call(this);
    }

    extend(_powerRoute, BaseRoute);

    _powerRoute.prototype.signal = function (H, rectLDown, rectRDown, rectLUp, rectRUp) {
