define(['Animation'], function (Animation) {
    ...
    var blacklist = {
        ...
        REVERSING = 3,
        idCounter = 0;
    var _tween = function (config) {
        var that = this,
            node = config.node,
            nodeId = node._id,
            duration = config.duration || 1,
            easing = config.easing || _easings.Linear,
            yoyo = !!config.yoyo,
    ...
    var _easings = {
        ...
        */
        'BounceEaseIn': function (t, b, c, d) {
            return c - _easings.BounceEaseOut(d - t, 0, c, d) + b;
        },
        /**
        * bounce ease in out
        * @function
        ...
        */
        'BounceEaseInOut': function (t, b, c, d) {
            if (t < d / 2) {
                return _easings.BounceEaseIn(t * 2, 0, c, d) * 0.5 + b;
            }
            else {
                return _easings.BounceEaseOut(t * 2 - d, 0, c, d) * 0.5 + c * 0.5 + b;
            }
        },
        /**
        * ease in
