 ...
 *  跨域获取json格式数据
 *  使用示例：
 *  Jsonp.self.getJson("http://www.water.hubu.edu.cn:8088/ArcGIS/rest/services/HAINAN/hainan/MapServer?f=json&pretty=true", null, function (data) {
 *      console.log(data);
 *  });
 *  @author yellow
 *  @class Hmap.Core.Jsonp

 */

define(function (Hmath, Hobject) {
